...
import { mockTrips, popularDestinations } from '@/lib/mock-data'
        ...
        {filteredDests.length > 0 && (
          <section>
            ...
            <div className="grid grid-cols-4 gap-4">
              {filteredDests.slice(0, 4).map(dest => (
                <div key={dest.city} className="relative rounded-xl overflow-hidden aspect-[4/3] bg-muted group cursor-pointer border border-border shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-200">
                  <Image src={dest.image} alt={dest.city} fill className="object-cover group-hover:scale-105 transition-transform duration-300" sizes="25vw" />
